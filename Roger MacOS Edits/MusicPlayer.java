...
public class MusicPlayer {
    ...
    ArrayList<File> jsonFiles = new ArrayList(Arrays.asList(Helpers.filterMacOS(songFolder)));
    ...
    ArrayList<File> playlists = new ArrayList(Arrays.asList(Helpers.filterMacOS(playlistFolder)));
    ...
    private void setSong(String s) throws FileNotFoundException {
        ...
        currSong.setmp3Location(Helpers.convertFilePath(currSong.getmp3Location()));
        currSong.setAlbumArt(Helpers.convertFilePath(currSong.getAlbumArt()));
    }
