...
public class MainScreenController implements Initializable {
    ...
    */
    ...
    public final Image defaultAlbumArt = new Image(defaultAlbumArtPath.toURI().toString());
    ...
    private void updateAlbumArt() {
        try {
            System.out.println(mp.getSong().getAlbumArt().getAbsolutePath());
            albumArtView.setImage(new Image(mp.getSong().getAlbumArt().toURI().toString()));
        }
        catch (Exception e) {
